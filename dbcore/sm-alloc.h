...
void *epoch_ended_context(void *cookie, void *epoch_cookie, void *context_cookie);
void epoch_reclaimed(void *cookie, void *epoch_cookie);
inline void register_context() { mm_epochs.context_init(); }
inline void deregister_context() { mm_epochs.context_fini(); }
inline epoch_num epoch_enter(void) { return mm_epochs.context_enter(); }

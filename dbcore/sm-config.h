...
static const uint32_t MAX_THREADS = MAX_CORES * 2 * 2; // number of pcontexts
...
extern bool hbm_arch;
extern uint32_t max_numa_node;
extern uint32_t scheduling_policy;
extern uint64_t arrival_interval_us;
extern uint32_t main_queue_size;
extern uint32_t prioritized_queue_size;
extern uint32_t global_queue_size;
extern uint32_t max_preempted_cycle_pct;
extern uint32_t switch_threshold;
extern uint32_t latency_sample_rate;
extern uint32_t latency_sample_size;
